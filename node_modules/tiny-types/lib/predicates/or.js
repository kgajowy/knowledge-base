...
var Or = /** @class */ (function (_super) {
    ...
    function Or(predicates) {
        ...
        if ([
            function (_) { return isDefined_1.isDefined().check(_); },
            function (_) { return isArray_1.isArray().check(_); },
            function (_) { return isGreaterThan_1.isGreaterThan(0).check(_.length); },
        ].some(function (check) { return check(_this.predicates) instanceof Predicate_1.Failure; })) {
    ...
    Or.prototype.check = function (value) {
        ...
        var describe = function (issues) { return "either " + issues.join(', ').replace(/,([^,]*)$/, ' or$1'); };
        return anySuccess
