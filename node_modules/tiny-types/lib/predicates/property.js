...
function property(prop) {
    ...
    return new HaveProperty(prop, and_1.and.apply(void 0, predicates));
}
exports.property = property;
/** @access private */
var HaveProperty = /** @class */ (function (_super) {
    __extends(HaveProperty, _super);
    function HaveProperty(prop, predicate) {
    ...
    HaveProperty.prototype.check = function (value) {
        var result = this.predicate.check(value[this.prop]);
        return result instanceof Predicate_1.Failure
            ? new Predicate_1.Failure(value, ("have a property \"" + this.prop + "\" that " + result.description)
                .replace(/\bbe\b/gi, 'is')
